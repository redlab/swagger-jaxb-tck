...
public class EnumerationTest {
	...
	public void setup() throws NoSuchMethodException, SecurityException {
		method = Root.class.getMethod("getEnumElement");
	...
	@Test
	public void allowableValuesCorrect() {
		failIfNoAnnotation();
		Assert.assertNotNull(apiProperty.allowableValues());
		Assert.assertEquals("ONE,TWO,THREE", apiProperty.allowableValues());
	}
